...
// Power ceiling by origin, relative to Auranthi (100). Adjustable in the Codex as the
// story progresses -- these are just the canon starting values.
// - Dravosi/Zyrenian carry diluted Auranthi ancestry, which sets their base ceiling.
// - Pairing with a Mutate can push a hybrid up toward (not guaranteed to reach) hybridMax.
// - Pairing with a plain Human never raises the ceiling above base.
// - Mutate and Human have no fixed ceiling of their own -- "varies" means individual,
//   not bounded by ancestry, which is the rare exception that can rival or exceed Auranthi.
export const POWER_SCALING_DEFAULTS={
  auranthi:{base:100,hybridMax:100,varies:false},
  dravosi:{base:50,hybridMax:75,varies:false},
  zyrenian:{base:25,hybridMax:50,varies:false},
  mutate:{base:null,hybridMax:null,varies:true},
  human:{base:null,hybridMax:null,varies:true},
};
...
export const ART_STYLES=[{id:"photoreal",label:"Photorealism",text:"ultra-photorealistic portrait, shot on a DSLR with an 85mm lens, natural skin texture with visible pores, realistic fabric and material physics, accurate human anatomy and proportions, photographic lighting and depth of field, lifelike eyes and skin tone, 8K ultra-detailed, indistinguishable from a real photograph"},{id:"comic",label:"Comic Art",text:"cinematic character concept art, flat color with sharp ink lines, bold graphic novel style"},{id:"rendered",label:"3D Render",text:"hyper-realistic CGI character design render, cinematic studio lighting, photorealistic detail"},{id:"anime",label:"Anime",text:"high-quality anime character illustration, dynamic cel shading, clean linework"},{id:"statue",label:"Statue",text:"collectible resin figurine render, museum-quality hand-painted detail, neutral display pose"}];
